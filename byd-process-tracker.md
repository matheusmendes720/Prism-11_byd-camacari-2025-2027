---
ueid: ikigai:deliverable:d4-process-tracker:byd-camari:2026-07
...
custom:
  ...
  _outputs:
    - "d4-process-tracker/byd-tracker.db -- SQLite 4 tables + 2 views, 12 outreach + 6 process rows"
    - "d4-process-tracker/byd-tracker-init.py -- Schema init (idempotent)"
    - "d4-process-tracker/byd-tracker-seed.py -- 6 seed companies + outreach rows (idempotent)"
    - "d4-process-tracker/byd-tracker-schema.sql -- Schema definition (4 tables + 2 views)"
  _success_criteria:
